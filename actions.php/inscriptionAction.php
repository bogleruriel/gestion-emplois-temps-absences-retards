...
if(empty($erreurs)){
    ...
    $requette = 'INSERT INTO utilisateur (nom, prenom, sexe, date_naissance, e_mail, nom_utilisateur, mot_de_passe) VALUES (:nom, :prenom, :sexe, :date_naissance, :e_mail, :nom_utilisateur, :mot_de_passe);';
...
header("location: ../index.php/inscription.php?erreurs=" . json_encode($erreurs) . "&donnees=" . json_encode($donnees) . "&message=" . json_encode($message_success));